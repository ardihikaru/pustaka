  ...
  pages: [
    {
      ...
      sections: [
        ...
        { anchor: "releases", title: "Releases",
          text: "v0.8.0 sign-in call to action in the landing hero plus the pustaka.onAuth hook for auth-aware page scripts, and a flex fix for the hero button row. v0.7.1 landing-layout fixes: the homepage menu button now opens the table of contents at every width, and the 921–1023 px band no longer reserves a phantom sidebar gutter that pushed the hero off-screen. v0.7.0 optional login layer with environment-held credentials, signed session cookie, animated login page and header sign-out. v0.6.0 optional page metadata, recursive sidebar menus, Markdown and navigation tutorials, five offline Sisflow diagram workbench/viewer guides, and partial-swap resource fix. v0.5.0 landing layout, screenshots and vendored assets. v0.4.0 interactive landing and AI authoring. v0.3.0 nested folders and multi-file ToC. v0.2.0 Go engine and AI kit. v0.1.0 static concept." }
      ]
    },
